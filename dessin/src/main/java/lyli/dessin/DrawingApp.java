...
/** lecture utilisateur. */
	...
	/** la méthode menu qui permet d'afficher
	 *  le menu pour l'utilisateur. */
	public final void menu() {
		System.out.println("############################### Bienvenue"
				+ " " + "au logiciel de dessin"
				+ " ##################################");
		System.out.println("###################################"
		...
		System.out.println("******* 1- Vous pouver créer une Forme "
				+ "(Cercle,Carre,Rectangle,Triangle)"
				+ " ou un groupe"
				+ " de " + "Forme ***");
		System.out.println("*************************************"
				+ "****************"
		...
		System.out.println("-------------Syntaxe génerale : move(nom "
				+ "de la forme a déplace, (decalage X,"
				+ " decalage Y)) " + "--------");
		System.out.println("-------------------- exemple"
				+ " d'un " + "Cercle : \"move(c1, (4, 5)) \""
						+ " ---------------"
				+ "------" + "--------------");
		System.out.println("-------------------- exemple"
				+ " d'un " + "Carre : \"move(ca1, (6, 2))\" "
						+ "-----------------"
				+ "-----" + "--------------");
		System.out.println("-------------------- exemple "
				+ "d'un" + " Rectangle : \"move(r1, (0, 14))"
						+ " \"----------"
				+ "--------" + "--------------");
		System.out.println("-------------------- exemple "
		...
		System.out.println("*****************************************"
				+ "*****************************************"
				+ "****************");
		System.out.println(" Pour commencer veuillez saisir "
				+ "votre commande : ");
	}

	/**
	 * la méthode run qui permet d'executer les commandes
	 *  de l'utilisateur.
	 *
	 ...
	 */
	public final void run() throws FormeDoncExistException, SQLException {
		this.menu();
	...
	public static void main(final String[] args) {
		...
		if (f.exists()) {
			System.err.println("Le nom du fichier existe déja "
		...
		while (!b) {
			...
			f = new File(name);
				if (f.exists()) {
					System.err.println("Le nom du fichier"
							+ " existe déja"
				+ " veuillez saisir un nouveau nom");
					b = false;
				} else {
